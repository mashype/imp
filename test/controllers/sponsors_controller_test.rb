...
class SponsorsControllerTest < ActionController::TestCase
  ...
  test "should create sponsor" do
    assert_difference('Sponsor.count') do
      post :create, sponsor: { disposition_id: @sponsor.disposition_id, employees: @sponsor.employees, incumbent: @sponsor.incumbent, name: @sponsor.name, renewal: @sponsor.renewal }
    end
  ...
  test "should update sponsor" do
    patch :update, id: @sponsor, sponsor: { disposition_id: @sponsor.disposition_id, employees: @sponsor.employees, incumbent: @sponsor.incumbent, name: @sponsor.name, renewal: @sponsor.renewal }
    assert_redirected_to sponsor_path(assigns(:sponsor))
  end
