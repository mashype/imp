class SponsorsController < ApplicationController 
  ...
  private
    ...
    def sponsor_params
      params.require(:sponsor).permit(:name, :employees, :incumbent, :renewal, :disposition_id, 
        tasks_attributes: [:id, :title, :user_id, :_destroy], 
        sponsormatches_attributes: [:id, :sponsor_id, :provider_id, :employees])
    end
